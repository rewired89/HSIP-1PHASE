...
HSIP is a UDP protocol, not HTTP. This script is misleading.

For proper HSIP replay attack testing, use:
    PowerShell: .\hsip_replay_attack.ps1
    or manually: hsip-cli consent-send-request (send same request twice)
