...
impl HsipErrorCode {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            HsipErrorCode::SessionConsentRevoked => "consent revoked during active session",
...
impl From<SessionError> for HsipErrorCode {
    fn from(se: SessionError) -> Self {
        match se {
            ...
            SessionError::ConsentRevoked => HsipErrorCode::SessionConsentRevoked,
        }
    }
}
